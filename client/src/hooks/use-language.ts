...
const translations: Translations = {
  ...
  de: {
    ...
    // Book field translations
    mainAuthor: "Hauptautor",
    additionalAuthors: "Zusätzliche Autoren",
    authorStatement: "Autorenangabe",
    publicationYear: "Erscheinungsjahr",
    publicationDate: "Erscheinungsdatum",
    publicationPlace: "Erscheinungsort",
